  ...
  return (
    ...
    >
      <defs>
        ...
        >
          <stop offset="0" stopColor="#8b6d4b"></stop>
          <stop offset="1" stopColor="#8b6d4b"></stop>
        </linearGradient>
      </defs>
      <g
        fill="url(#color-1_5MQ0gPAYYx7a_gr1)"
        fillRule="nonzero"
        stroke="none"
        strokeWidth="1"
        strokeLinecap="butt"
